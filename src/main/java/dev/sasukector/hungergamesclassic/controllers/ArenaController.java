...
public class ArenaController {
    ...
    public void createArenas() {
        ...
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 500, 68, -75));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 488, 74, -170));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 473, 74, -180));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 485, 78, -181));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 478, 64, -213));
        ...
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 231, 59, -183));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 84, 130, -492));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 82, 122, -488));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 77, 72, -490));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 44, 78, -329));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 65, 59, -247));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 51, 72, -170));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 116, 64, -112));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), 109, 61, -119));
        ...
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -379, 67, 456));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -441, 101, 384));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -395, 85, 81));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -467, 64, -49));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -498, 98, -141));
        ...
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -31, 106, -396));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -90, 66, -166));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -192, 39, -117));
        arena1.getChestLocations().add(new Location(arena1.getWorld(), -229, 92, -39));
